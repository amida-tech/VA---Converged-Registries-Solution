...
namespace CRSe_WEB.Common
{
    public partial class Referrals : BasePage
    {
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        gridRegistry.Columns[0].Visible = linkReferralAdd.Visible = false;
                        SetReadOnly();
                    }
                    ...
                    if (!Page.IsPostBack)
                    {
                        ...
                        if (UserSession.PageMode == PageModes.Edit && UserSession.CurrentReferralId > 0)
                        {
                        ...
                        else
                        {
                            ...
                            pnlReferral.Visible = pnlSearch.Visible = false;
                        }
                    }
                }
            }
        ...
        protected void LinkReferralAdd_Click(object sender, EventArgs e)
        {
            ServiceInterfaceManager.LogInformation("POSTBACK_EVENT", String.Format("{0}.{1}", System.Reflection.MethodBase.GetCurrentMethod().DeclaringType.FullName, System.Reflection.MethodBase.GetCurrentMethod().Name), HttpContext.Current.User.Identity.Name, UserSession.CurrentRegistryId);
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                if (ex.Message.ToLower().Contains("already exists"))
                    lblResult.Text = "The Referral you are saving already exists<br /><br />";
                else
                {
                    ServiceInterfaceManager.LogError(ex.Message, String.Format("{0}.{1}", System.Reflection.MethodBase.GetCurrentMethod().DeclaringType.FullName, System.Reflection.MethodBase.GetCurrentMethod().Name), HttpContext.Current.User.Identity.Name, UserSession.CurrentRegistryId);
                    throw ex;
