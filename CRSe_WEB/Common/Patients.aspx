<%@ Page Title="Patients" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Patients.aspx.cs" Inherits="CRSe_WEB.Common.Patients" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Label ID="lblPageTitle" runat="server" Text="Patients" Font-Size="X-Large" />
    <br /><br />
    ...
    <asp:Panel ID="pnlPatients" runat="server">
        ...
        <asp:DropDownList ID="ddlSearch" runat="server" ToolTip="Select to filter column view results" AutoPostBack="false">
            <asp:ListItem Text="Patient ID" Value="PATIENT_ID"></asp:ListItem>
        ...
        <br /><br />
        <asp:GridView ID="gridRegistry" runat="server" DataSourceID="dsRegistry" EmptyDataText="Currently no Patients are available" 
            ...
            <Columns>
                <asp:TemplateField ItemStyle-Wrap="false">
                    <ItemTemplate>
                        <asp:LinkButton ID="linkDelete" runat="server" Text="Delete" OnClick="LinkDelete_Click" CommandArgument='<%# Eval("PATIENT_ID") %>' />
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField  HeaderStyle-ForeColor="White" SortExpression="PATIENT_ID" AccessibleHeaderText="PATIENT_ID" HeaderText="PATIENT ID">
                    <ItemTemplate>
                        <asp:LinkButton ID="linkSelectPatient" runat="server" Text='<%# Eval("PATIENT_ID") %>' OnClick="LinkSelectPatient_Click" CommandArgument='<%# Eval("REFERRAL_ID") %>' />
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField  HeaderStyle-ForeColor="White" SortExpression="PROVIDER_ID" AccessibleHeaderText="PROVIDER_ID" HeaderText="PROVIDER ID">
                    <ItemTemplate>
                        <asp:LinkButton ID="linkSelectProvider" runat="server" Text='<%# Eval("PROVIDER_ID") %>' OnClick="LinkSelectProvider_Click" CommandArgument='<%# Eval("REFERRAL_ID") %>' />
                    </ItemTemplate>
                </asp:TemplateField>
        ...
        <br />
        <asp:LinkButton ID="linkPatientAdd" runat="server" Text="Add New Patient" OnClick="LinkPatientAdd_Click" ToolTip="Select to add a new Patient" />
    ...
    <asp:Panel ID="pnlPatient" runat="server">
        ...
        <asp:Table ID="tblSaveForm" runat="server">
            <asp:TableRow>
                <asp:TableCell>
                    <asp:Button ID="btnSave" runat="server" Text="Save" OnClick="BtnSave_Click" ToolTip="Select to add Referral to the Registry" OnClientClick='return confirm("Are you sure you want to add this Patient to the Registry?");' />
                    &nbsp;&nbsp;
