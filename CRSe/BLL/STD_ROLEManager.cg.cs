...
namespace CRSe.CRS.BLL
{
	public static partial class STD_ROLEManager
	{
		...
		public static STD_ROLE GetItem(string CURRENT_USER, Int32 CURRENT_REGISTRY_ID, Int32 ID)
		{
		...
		public static List<STD_ROLE> GetItems(string CURRENT_USER, Int32 CURRENT_REGISTRY_ID)
		{
		...
		public static Int32 Save(string CURRENT_USER, Int32 CURRENT_REGISTRY_ID, STD_ROLE objSave)
		{
			Int32 objReturn = 0;
			STD_ROLEDB objDB = new STD_ROLEDB();
		...
		public static Boolean Delete(string CURRENT_USER, Int32 CURRENT_REGISTRY_ID, STD_ROLE objDelete)
		{
