...
namespace CRSe.CRS.DAL
{
	public partial class REGISTRY_CORE_DATADB : DBUtils
	{
		...
		public REGISTRY_CORE_DATA GetItem(string CURRENT_USER, Int32 CURRENT_REGISTRY_ID, Int32 CORE_DATA_ID)
		{
			...
			try
			{
				...
				sCmd = new SqlCommand("CRS.usp_REGISTRY_CORE_DATA_getitem", sConn);
				sCmd.CommandTimeout = SqlCommandTimeout;
				sCmd.CommandType = CommandType.StoredProcedure;
				sCmd.Parameters.AddWithValue("@CURRENT_USER", CURRENT_USER);
				sCmd.Parameters.AddWithValue("@CURRENT_REGISTRY_ID", CURRENT_REGISTRY_ID);
				sCmd.Parameters.AddWithValue("@CORE_DATA_ID", CORE_DATA_ID);
		...
		public List<REGISTRY_CORE_DATA> GetItems(string CURRENT_USER, Int32 CURRENT_REGISTRY_ID)
		{
			...
			try
			{
				...
				sCmd = new SqlCommand("CRS.usp_REGISTRY_CORE_DATA_getitems", sConn);
				sCmd.CommandTimeout = SqlCommandTimeout;
				sCmd.CommandType = CommandType.StoredProcedure;
				sCmd.Parameters.AddWithValue("@CURRENT_USER", CURRENT_USER);
				sCmd.Parameters.AddWithValue("@CURRENT_REGISTRY_ID", CURRENT_REGISTRY_ID);
		...
		public Boolean Delete(string CURRENT_USER, Int32 CURRENT_REGISTRY_ID, Int32 CORE_DATA_ID)
		{
			...
			try
			{
				...
				sCmd = new SqlCommand("CRS.usp_REGISTRY_CORE_DATA_delete", sConn);
				sCmd.CommandTimeout = SqlCommandTimeout;
				sCmd.CommandType = CommandType.StoredProcedure;
				sCmd.Parameters.AddWithValue("@CURRENT_USER", CURRENT_USER);
				sCmd.Parameters.AddWithValue("@CURRENT_REGISTRY_ID", CURRENT_REGISTRY_ID);
		...
		public REGISTRY_CORE_DATA ParseReader(DataRow row)
		{
			REGISTRY_CORE_DATA objReturn = new REGISTRY_CORE_DATA
			{
				COMMENT = (string)GetNullableObject(row.Field<object>("COMMENT")),
				CORE_DATA_ID = (Int32)GetNullableObject(row.Field<object>("CORE_DATA_ID")),
                ...
                SELECTED_FLAG = (Boolean)GetNullableObject(row.Field<object>("SELECTED_FLAG"))
			};

			return objReturn;
		}

		public REGISTRY_CORE_DATA ParseReaderCustom(DataRow row)
		{
			REGISTRY_CORE_DATA objReturn = new REGISTRY_CORE_DATA
			{
				COMMENT = (string)GetNullableObject(row.Field<object>("REGISTRY_CORE_DATA_COMMENT")),
				CORE_DATA_ID = (Int32)GetNullableObject(row.Field<object>("REGISTRY_CORE_DATA_CORE_DATA_ID")),
				CORE_TYPE_ID = (Int32)GetNullableObject(row.Field<object>("REGISTRY_CORE_DATA_CORE_TYPE_ID")),
				CREATED = (DateTime)GetNullableObject(row.Field<object>("REGISTRY_CORE_DATA_CREATED")),
				CREATEDBY = (string)GetNullableObject(row.Field<object>("REGISTRY_CORE_DATA_CREATEDBY")),
				STD_REGISTRY_ID = (Int32)GetNullableObject(row.Field<object>("REGISTRY_CORE_DATA_STD_REGISTRY_ID")),
				UPDATED = (DateTime)GetNullableObject(row.Field<object>("REGISTRY_CORE_DATA_UPDATED")),
				UPDATEDBY = (string)GetNullableObject(row.Field<object>("REGISTRY_CORE_DATA_UPDATEDBY")),
				VALUE = (string)GetNullableObject(row.Field<object>("REGISTRY_CORE_DATA_VALUE")),
                SELECTED_FLAG = (Boolean)GetNullableObject(row.Field<object>("REGISTRY_CORE_DATA_SELECTED_FLAG"))
			};
