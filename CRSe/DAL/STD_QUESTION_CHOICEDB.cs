...
namespace CRSe.CRS.DAL
{
	public partial class STD_QUESTION_CHOICEDB : DBUtils
	{
        ...
        public List<STD_QUESTION_CHOICE> GetItemsByQuestion(string CURRENT_USER, Int32 CURRENT_REGISTRY_ID, Int32 STD_QUESTION_ID)
        {
            ...
            try
            {
                ...
                sCmd = new SqlCommand("CRS.usp_STD_QUESTION_CHOICE_getitemsByQuestion", sConn);
                sCmd.CommandTimeout = SqlCommandTimeout;
                sCmd.CommandType = CommandType.StoredProcedure;
                sCmd.Parameters.AddWithValue("@CURRENT_USER", CURRENT_USER);
                sCmd.Parameters.AddWithValue("@CURRENT_REGISTRY_ID", CURRENT_REGISTRY_ID);
                sCmd.Parameters.AddWithValue("@STD_QUESTION_ID", STD_QUESTION_ID);
