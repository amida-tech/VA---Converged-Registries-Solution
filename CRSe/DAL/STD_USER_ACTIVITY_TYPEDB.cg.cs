...
{
	public partial class STD_USER_ACTIVITY_TYPEDB : DBUtils
	{
		#region Fields
		#endregion
		...
		public STD_USER_ACTIVITY_TYPEDB()
		{
		}
		...
		public STD_USER_ACTIVITY_TYPE GetItem(string CURRENT_USER, Int32 CURRENT_REGISTRY_ID, Int32 ID)
		{
			...
			try
			{
				...
				sCmd = new SqlCommand("CRS.usp_STD_USER_ACTIVITY_TYPE_getitem", sConn);
		...
		public List<STD_USER_ACTIVITY_TYPE> GetItems(string CURRENT_USER, Int32 CURRENT_REGISTRY_ID)
		{
			...
			try
			{
				...
				sCmd = new SqlCommand("CRS.usp_STD_USER_ACTIVITY_TYPE_getitems", sConn);
				sCmd.CommandTimeout = SqlCommandTimeout;
				sCmd.CommandType = CommandType.StoredProcedure;
				sCmd.Parameters.AddWithValue("@CURRENT_USER", CURRENT_USER);
				sCmd.Parameters.AddWithValue("@CURRENT_REGISTRY_ID", CURRENT_REGISTRY_ID);
				...
				if (objTemp != null  && objTemp.Tables.Count > 0 && objTemp.Tables[0].Rows.Count > 0)
				{
					...
					if (myData != null)
					{
						objReturn = myData.ToList<STD_USER_ACTIVITY_TYPE>();
					}
				}
		...
		public Int32 Save(string CURRENT_USER, Int32 CURRENT_REGISTRY_ID, STD_USER_ACTIVITY_TYPE objSave)
		{
			Int32 objReturn = 0;
			...
			try
			{
				...
				sCmd = new SqlCommand("CRS.usp_STD_USER_ACTIVITY_TYPE_save", sConn);
				sCmd.CommandTimeout = SqlCommandTimeout;
				sCmd.CommandType = CommandType.StoredProcedure;
				sCmd.Parameters.AddWithValue("@CURRENT_USER", CURRENT_USER);
				sCmd.Parameters.AddWithValue("@CURRENT_REGISTRY_ID", CURRENT_REGISTRY_ID);
		...
		public Boolean Delete(string CURRENT_USER, Int32 CURRENT_REGISTRY_ID, Int32 ID)
		{
			...
			try
			{
				...
				sCmd = new SqlCommand("CRS.usp_STD_USER_ACTIVITY_TYPE_delete", sConn);
				sCmd.CommandTimeout = SqlCommandTimeout;
				sCmd.CommandType = CommandType.StoredProcedure;
				sCmd.Parameters.AddWithValue("@CURRENT_USER", CURRENT_USER);
				sCmd.Parameters.AddWithValue("@CURRENT_REGISTRY_ID", CURRENT_REGISTRY_ID);
		...
		public STD_USER_ACTIVITY_TYPE ParseReader(DataRow row)
		{
			STD_USER_ACTIVITY_TYPE objReturn = new STD_USER_ACTIVITY_TYPE
			{
		...
		public STD_USER_ACTIVITY_TYPE ParseReaderCustom(DataRow row)
		{
			STD_USER_ACTIVITY_TYPE objReturn = new STD_USER_ACTIVITY_TYPE
			{
				CODE = (string)GetNullableObject(row.Field<object>("STD_USER_ACTIVITY_TYPE_CODE")),
				COMMENTS = (string)GetNullableObject(row.Field<object>("STD_USER_ACTIVITY_TYPE_COMMENTS")),
				CREATED = (DateTime)GetNullableObject(row.Field<object>("STD_USER_ACTIVITY_TYPE_CREATED")),
				CREATEDBY = (string)GetNullableObject(row.Field<object>("STD_USER_ACTIVITY_TYPE_CREATEDBY")),
				DESCRIPTION_TEXT = (string)GetNullableObject(row.Field<object>("STD_USER_ACTIVITY_TYPE_DESCRIPTION_TEXT")),
				ID = (Int32)GetNullableObject(row.Field<object>("STD_USER_ACTIVITY_TYPE_ID")),
				NAME = (string)GetNullableObject(row.Field<object>("STD_USER_ACTIVITY_TYPE_NAME")),
				STD_REGISTRY_ID = (Int32?)GetNullableObject(row.Field<object>("STD_USER_ACTIVITY_TYPE_STD_REGISTRY_ID")),
				UPDATED = (DateTime)GetNullableObject(row.Field<object>("STD_USER_ACTIVITY_TYPE_UPDATED")),
				UPDATEDBY = (string)GetNullableObject(row.Field<object>("STD_USER_ACTIVITY_TYPE_UPDATEDBY"))
			};
