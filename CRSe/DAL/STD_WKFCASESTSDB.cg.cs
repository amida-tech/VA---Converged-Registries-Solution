...
{
	public partial class STD_WKFCASESTSDB : DBUtils
	{
		#region Fields
		#endregion
		...
		public STD_WKFCASESTS GetItem(string CURRENT_USER, Int32 CURRENT_REGISTRY_ID, Int32 ID)
		{
			...
			try
			{
				...
				sCmd = new SqlCommand("CRS.usp_STD_WKFCASESTS_getitem", sConn);
		...
		public List<STD_WKFCASESTS> GetItems(string CURRENT_USER, Int32 CURRENT_REGISTRY_ID)
		{
			...
			try
			{
				...
				sCmd = new SqlCommand("CRS.usp_STD_WKFCASESTS_getitems", sConn);
				sCmd.CommandTimeout = SqlCommandTimeout;
				sCmd.CommandType = CommandType.StoredProcedure;
				sCmd.Parameters.AddWithValue("@CURRENT_USER", CURRENT_USER);
				sCmd.Parameters.AddWithValue("@CURRENT_REGISTRY_ID", CURRENT_REGISTRY_ID);
				...
				if (objTemp != null  && objTemp.Tables.Count > 0 && objTemp.Tables[0].Rows.Count > 0)
				{
					...
					if (myData != null)
					{
						objReturn = myData.ToList<STD_WKFCASESTS>();
					}
				}
		...
		public Int32 Save(string CURRENT_USER, Int32 CURRENT_REGISTRY_ID, STD_WKFCASESTS objSave)
		{
			Int32 objReturn = 0;
			...
			try
			{
				...
				sCmd = new SqlCommand("CRS.usp_STD_WKFCASESTS_save", sConn);
				sCmd.CommandTimeout = SqlCommandTimeout;
				sCmd.CommandType = CommandType.StoredProcedure;
				sCmd.Parameters.AddWithValue("@CURRENT_USER", CURRENT_USER);
				sCmd.Parameters.AddWithValue("@CURRENT_REGISTRY_ID", CURRENT_REGISTRY_ID);
		...
		public Boolean Delete(string CURRENT_USER, Int32 CURRENT_REGISTRY_ID, Int32 ID)
		{
			...
			try
			{
				...
				sCmd = new SqlCommand("CRS.usp_STD_WKFCASESTS_delete", sConn);
				sCmd.CommandTimeout = SqlCommandTimeout;
				sCmd.CommandType = CommandType.StoredProcedure;
				sCmd.Parameters.AddWithValue("@CURRENT_USER", CURRENT_USER);
				sCmd.Parameters.AddWithValue("@CURRENT_REGISTRY_ID", CURRENT_REGISTRY_ID);
		...
		public STD_WKFCASESTS ParseReader(DataRow row)
		{
			STD_WKFCASESTS objReturn = new STD_WKFCASESTS
			{
		...
		public STD_WKFCASESTS ParseReaderCustom(DataRow row)
		{
			STD_WKFCASESTS objReturn = new STD_WKFCASESTS
			{
				CODE = (string)GetNullableObject(row.Field<object>("STD_WKFCASESTS_CODE")),
				CREATED = (DateTime)GetNullableObject(row.Field<object>("STD_WKFCASESTS_CREATED")),
				CREATEDBY = (string)GetNullableObject(row.Field<object>("STD_WKFCASESTS_CREATEDBY")),
				DESCRIPTION_TEXT = (string)GetNullableObject(row.Field<object>("STD_WKFCASESTS_DESCRIPTION_TEXT")),
				ID = (Int32)GetNullableObject(row.Field<object>("STD_WKFCASESTS_ID")),
				INACTIVE_DATE = (DateTime?)GetNullableObject(row.Field<object>("STD_WKFCASESTS_INACTIVE_DATE")),
				INACTIVE_FLAG = (bool)GetNullableObject(row.Field<object>("STD_WKFCASESTS_INACTIVE_FLAG")),
				NAME = (string)GetNullableObject(row.Field<object>("STD_WKFCASESTS_NAME")),
				SORT_ORDER = (Int32)GetNullableObject(row.Field<object>("STD_WKFCASESTS_SORT_ORDER")),
				UPDATED = (DateTime)GetNullableObject(row.Field<object>("STD_WKFCASESTS_UPDATED")),
				UPDATEDBY = (string)GetNullableObject(row.Field<object>("STD_WKFCASESTS_UPDATEDBY"))
			};
