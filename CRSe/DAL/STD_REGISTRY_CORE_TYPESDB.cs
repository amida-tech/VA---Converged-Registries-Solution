...
namespace CRSe.CRS.DAL
{
	public partial class STD_REGISTRY_CORE_TYPESDB : DBUtils
	{
        ...
        public List<STD_REGISTRY_CORE_TYPES> GetItems(string CURRENT_USER, Int32 CURRENT_REGISTRY_ID, string TABLE_NAME)
        {
            ...
            try
            {
                ...
                sCmd = new SqlCommand("CRS.usp_STD_REGISTRY_CORE_TYPES_getitemsByTableName", sConn);
        ...
        public STD_REGISTRY_CORE_TYPES GetItemByTableCode(string TABLE_NAME, string CODE)
        {
            ...
            try
            {
                ...
                sCmd = new SqlCommand("CRS.usp_STD_REGISTRY_CORE_TYPES_getitemByTableCode", sConn);
                sCmd.CommandTimeout = SqlCommandTimeout;
                sCmd.CommandType = CommandType.StoredProcedure;
                sCmd.Parameters.AddWithValue("@TABLE_NAME", TABLE_NAME);
