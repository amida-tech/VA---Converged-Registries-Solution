...
namespace CRSe.CRS.DAL
{
	public partial class STD_REGISTRYDB : DBUtils
	{
		...
		public STD_REGISTRY GetItem(string CURRENT_USER, Int32 CURRENT_REGISTRY_ID, Int32 ID)
		{
		...
		public List<STD_REGISTRY> GetItems(string CURRENT_USER, Int32 CURRENT_REGISTRY_ID)
		{
			...
			try
			{
				...
				sCmd = new SqlCommand("CRS.usp_STD_REGISTRY_getitems", sConn);
				sCmd.CommandTimeout = SqlCommandTimeout;
				sCmd.CommandType = CommandType.StoredProcedure;
				sCmd.Parameters.AddWithValue("@CURRENT_USER", CURRENT_USER);
				sCmd.Parameters.AddWithValue("@CURRENT_REGISTRY_ID", CURRENT_REGISTRY_ID);
		...
		public Boolean Delete(string CURRENT_USER, Int32 CURRENT_REGISTRY_ID, Int32 ID)
		{
			...
			try
			{
				...
				sCmd = new SqlCommand("CRS.usp_STD_REGISTRY_delete", sConn);
				sCmd.CommandTimeout = SqlCommandTimeout;
				sCmd.CommandType = CommandType.StoredProcedure;
				sCmd.Parameters.AddWithValue("@CURRENT_USER", CURRENT_USER);
				sCmd.Parameters.AddWithValue("@CURRENT_REGISTRY_ID", CURRENT_REGISTRY_ID);
		...
		public STD_REGISTRY ParseReader(DataRow row)
		{
			STD_REGISTRY objReturn = new STD_REGISTRY
			{
				...
				REGISTRY_ADMINISTRATOR = (Int32?)GetNullableObject(row.Field<object>("REGISTRY_ADMINISTRATOR")),
				REGISTRY_OWNER = (Int32?)GetNullableObject(row.Field<object>("REGISTRY_OWNER")),
				REGISTRY_SUPPORT_CONTACT = (Int32?)GetNullableObject(row.Field<object>("REGISTRY_SUPPORT_CONTACT")),
