...
{
	public partial class STD_WKFCASETYPEDB : DBUtils
	{
		#region Fields
		#endregion
		...
		public STD_WKFCASETYPE GetItem(string CURRENT_USER, Int32 CURRENT_REGISTRY_ID, Int32 ID)
		{
			...
			try
			{
				...
				sCmd = new SqlCommand("CRS.usp_STD_WKFCASETYPE_getitem", sConn);
		...
		public List<STD_WKFCASETYPE> GetItems(string CURRENT_USER, Int32 CURRENT_REGISTRY_ID)
		{
			...
			try
			{
				...
				sCmd = new SqlCommand("CRS.usp_STD_WKFCASETYPE_getitems", sConn);
				sCmd.CommandTimeout = SqlCommandTimeout;
				sCmd.CommandType = CommandType.StoredProcedure;
				sCmd.Parameters.AddWithValue("@CURRENT_USER", CURRENT_USER);
				sCmd.Parameters.AddWithValue("@CURRENT_REGISTRY_ID", CURRENT_REGISTRY_ID);
				...
				if (objTemp != null  && objTemp.Tables.Count > 0 && objTemp.Tables[0].Rows.Count > 0)
				{
					...
					if (myData != null)
					{
						objReturn = myData.ToList<STD_WKFCASETYPE>();
					}
				}
		...
		public Int32 Save(string CURRENT_USER, Int32 CURRENT_REGISTRY_ID, STD_WKFCASETYPE objSave)
		{
			Int32 objReturn = 0;
			...
			try
			{
				...
				sCmd = new SqlCommand("CRS.usp_STD_WKFCASETYPE_save", sConn);
				sCmd.CommandTimeout = SqlCommandTimeout;
				sCmd.CommandType = CommandType.StoredProcedure;
				sCmd.Parameters.AddWithValue("@CURRENT_USER", CURRENT_USER);
				sCmd.Parameters.AddWithValue("@CURRENT_REGISTRY_ID", CURRENT_REGISTRY_ID);
		...
		public Boolean Delete(string CURRENT_USER, Int32 CURRENT_REGISTRY_ID, Int32 ID)
		{
			...
			try
			{
				...
				sCmd = new SqlCommand("CRS.usp_STD_WKFCASETYPE_delete", sConn);
				sCmd.CommandTimeout = SqlCommandTimeout;
				sCmd.CommandType = CommandType.StoredProcedure;
				sCmd.Parameters.AddWithValue("@CURRENT_USER", CURRENT_USER);
				sCmd.Parameters.AddWithValue("@CURRENT_REGISTRY_ID", CURRENT_REGISTRY_ID);
		...
		public STD_WKFCASETYPE ParseReader(DataRow row)
		{
			STD_WKFCASETYPE objReturn = new STD_WKFCASETYPE
			{
		...
		public STD_WKFCASETYPE ParseReaderCustom(DataRow row)
		{
			STD_WKFCASETYPE objReturn = new STD_WKFCASETYPE
			{
				AUTO_CREATE = (bool?)GetNullableObject(row.Field<object>("STD_WKFCASETYPE_AUTO_CREATE")),
				CODE = (string)GetNullableObject(row.Field<object>("STD_WKFCASETYPE_CODE")),
				CREATED = (DateTime)GetNullableObject(row.Field<object>("STD_WKFCASETYPE_CREATED")),
				CREATEDBY = (string)GetNullableObject(row.Field<object>("STD_WKFCASETYPE_CREATEDBY")),
				DESCRIPTION_TEXT = (string)GetNullableObject(row.Field<object>("STD_WKFCASETYPE_DESCRIPTION_TEXT")),
				ID = (Int32)GetNullableObject(row.Field<object>("STD_WKFCASETYPE_ID")),
				INACTIVE_DATE = (DateTime?)GetNullableObject(row.Field<object>("STD_WKFCASETYPE_INACTIVE_DATE")),
				INACTIVE_FLAG = (bool)GetNullableObject(row.Field<object>("STD_WKFCASETYPE_INACTIVE_FLAG")),
				Name = (string)GetNullableObject(row.Field<object>("STD_WKFCASETYPE_Name")),
				SORT_ORDER = (Int32)GetNullableObject(row.Field<object>("STD_WKFCASETYPE_SORT_ORDER")),
				STD_REGISTRY_ID = (Int32?)GetNullableObject(row.Field<object>("STD_WKFCASETYPE_STD_REGISTRY_ID")),
				UPDATED = (DateTime)GetNullableObject(row.Field<object>("STD_WKFCASETYPE_UPDATED")),
				UPDATEDBY = (string)GetNullableObject(row.Field<object>("STD_WKFCASETYPE_UPDATEDBY"))
			};
