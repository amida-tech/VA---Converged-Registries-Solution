...
{
	public partial class STD_WKFACTIVITYSTSDB : DBUtils
	{
		#region Fields
		#endregion
		...
		public STD_WKFACTIVITYSTS GetItem(string CURRENT_USER, Int32 CURRENT_REGISTRY_ID, Int32 ID)
		{
			...
			try
			{
				...
				sCmd = new SqlCommand("CRS.usp_STD_WKFACTIVITYSTS_getitem", sConn);
		...
		public List<STD_WKFACTIVITYSTS> GetItems(string CURRENT_USER, Int32 CURRENT_REGISTRY_ID)
		{
			...
			try
			{
				...
				sCmd = new SqlCommand("CRS.usp_STD_WKFACTIVITYSTS_getitems", sConn);
				sCmd.CommandTimeout = SqlCommandTimeout;
				sCmd.CommandType = CommandType.StoredProcedure;
				sCmd.Parameters.AddWithValue("@CURRENT_USER", CURRENT_USER);
				sCmd.Parameters.AddWithValue("@CURRENT_REGISTRY_ID", CURRENT_REGISTRY_ID);
				...
				if (objTemp != null  && objTemp.Tables.Count > 0 && objTemp.Tables[0].Rows.Count > 0)
				{
					...
					if (myData != null)
					{
						objReturn = myData.ToList<STD_WKFACTIVITYSTS>();
					}
				}
		...
		public Boolean Delete(string CURRENT_USER, Int32 CURRENT_REGISTRY_ID, Int32 ID)
		{
			...
			try
			{
				...
				sCmd = new SqlCommand("CRS.usp_STD_WKFACTIVITYSTS_delete", sConn);
				sCmd.CommandTimeout = SqlCommandTimeout;
				sCmd.CommandType = CommandType.StoredProcedure;
				sCmd.Parameters.AddWithValue("@CURRENT_USER", CURRENT_USER);
				sCmd.Parameters.AddWithValue("@CURRENT_REGISTRY_ID", CURRENT_REGISTRY_ID);
		...
		public STD_WKFACTIVITYSTS ParseReader(DataRow row)
		{
